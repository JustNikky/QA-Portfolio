...
| **Test data** | API: `JSONPlaceholder`<br>Base URL: `https://jsonplaceholder.typicode.com`<br>Endpoint: `/users/5`<br>Request body:<br>```json<br>{<br>  "name": "Anna Nováková",<br>  "email": "anna.new@test.cz",<br>  "username": "annanovakova"<br>}<br>``` |
