...
| **Test data** | API: `JSONPlaceholder`<br>Base URL: `https://jsonplaceholder.typicode.com`<br>Endpoint: `/users/`<br>Request body:<br>```"name": "Niky QA", "username": "nikyqa", "email": "niky.qa@test.cz"``` |
