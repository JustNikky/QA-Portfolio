...
| **Test data** | API: `JSONPlaceholder`<br>Base URL: `https://jsonplaceholder.typicode.com`<br>Endpoint: `/users/`<br>Request body:<br>```json<br>{<br>  "name": "Niky QA",<br>  "username": "nikyqa",<br>  "email": "niky.qa@test.cz"<br>}<br>``` |
