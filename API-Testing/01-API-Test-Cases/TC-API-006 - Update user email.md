...
| **Test data** | API: `JSONPlaceholder`<br>Base URL: `https://jsonplaceholder.typicode.com`<br>Endpoint: `/users/5`<br>Request body:<br>```json<br>{<br>  "email": "new.email@test.cz"<br>}<br>``` |
