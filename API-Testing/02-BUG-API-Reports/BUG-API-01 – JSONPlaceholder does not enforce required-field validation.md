...
| **Steps to reproduce** | 1. Send a **POST** request to `/users/`.<br><br>2. Use a request body without the `email` field:<br><br>```"name": "Anna Nováková",<br>  "username": "annanovakova"```<br><br>3. Send the request. |
